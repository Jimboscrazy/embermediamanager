...
Namespace EBML
    <Serialization.EbmlType(GetType(String))> _
 Public Class EbmlStringElement
        ...
        Public Overrides Sub UpdateValue(ByVal data As Byte(), ByVal offset As Integer, ByVal size As Integer)
            _value = Encoding.UTF8.GetString(data, offset, size)
        End Sub
        ...
        Public Overrides Sub WriteTo(ByVal strm As Stream, ByVal options As EBMLWriteOptions)
            Dim raw As Byte() = Encoding.UTF8.GetBytes(_value)
