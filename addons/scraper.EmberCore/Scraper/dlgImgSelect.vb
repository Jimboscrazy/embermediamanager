            ...
            For i As Integer = 0 To Me.TMDBPosters.Count - 1
                Select Case True
                    Case RemoveServerURL(Me.TMDBPosters.Item(i).URL) = String.Concat(sLeft, "-original.jpg")
                        ...
                        End If
                    Case RemoveServerURL(Me.TMDBPosters.Item(i).URL) = RemoveServerURL(sURL) 'String.Concat(sLeft, "-cover.jpg")
                        ' large
                        If Not Master.eSettings.UseImgCache OrElse Not IsNothing(TMDBPosters.Item(i).WebImage.Image) Then
                            ...
                            Me.rbLarge.Text = String.Format(Master.eLang.GetString(52, "Cover ({0}x{1})"), Me.TMDBPosters.Item(i).Width, Me.TMDBPosters.Item(i).Height)
                        End If
                    Case RemoveServerURL(Me.TMDBPosters.Item(i).URL) = String.Concat(sLeft, "-thumb.jpg")
                        ...
                        End If
                    Case RemoveServerURL(Me.TMDBPosters.Item(i).URL) = String.Concat(sLeft, "-mid.jpg")
                        ...
                        Me.rbMedium.Text = String.Format(Master.eLang.GetString(54, "Medium ({0}x{1})"), Me.TMDBPosters.Item(i).Width, Me.TMDBPosters.Item(i).Height)
                End Select
            Next
