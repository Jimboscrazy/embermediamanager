...
Public Class NFO
    ...
    Public Shared Function GetNfoPath(ByVal sPath As String, ByVal isSingle As Boolean) As String
        ...
        If Master.eSettings.VideoTSParent AndAlso FileManip.Common.isVideoTS(sPath) Then
            ...
            Else
                ...
                End If
            End If
        ElseIf Master.eSettings.VideoTSParent AndAlso FileManip.Common.isBDRip(sPath) Then
    ...
    Public Shared Sub SaveMovieToNFO(ByRef movieToSave As Master.DBMovie)
        ...
        Try
            ...
            If Master.eSettings.VideoTSParent AndAlso FileManip.Common.isVideoTS(movieToSave.Filename) Then
                ...
                End If
            ElseIf Master.eSettings.VideoTSParent AndAlso FileManip.Common.isBDRip(movieToSave.Filename) Then
            ...
            Else
                ...
                If Master.eSettings.MovieNameNFO AndAlso (Not movieToSave.isSingle OrElse Not Master.eSettings.MovieNameMultiOnly) Then
                    If FileManip.Common.isVideoTS(movieToSave.Filename) Then
                        tPath = Path.Combine(Directory.GetParent(movieToSave.Filename).FullName, "video_ts.nfo")
                    ElseIf FileManip.Common.isBDRip(movieToSave.Filename) Then
