...
mResult:
        ...
        Private Function GetMovieInfo(ByVal strID As String, ByRef IMDBMovie As Media.Movie, ByVal FullCrew As Boolean, ByVal FullCast As Boolean, ByVal GetPoster As Boolean) As Boolean
            Try
                ...
                IMDBMovie.Title = CleanTitle(Web.HttpUtility.HtmlDecode(Regex.Match(OriginalTitle, ".*(?=\s\(\d+.*?\))").ToString))
                IMDBMovie.OriginalTitle = IMDBMovie.Title
                If GetPoster Then
                ...
                Dim Cast As List(Of Media.Person) = Cast1.ToList  ' Cast1.Union(Cast2).ToList
