...
Partial Class frmMain
    ...
    Private Sub InitializeComponent()
        ...
        Me.RenamerToolStripMenuItem.Text = "Renamer"
        '
        'scMain
        '
