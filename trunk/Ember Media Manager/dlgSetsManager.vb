...
Public Class dlgSetsManager
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        If Me.lbMoviesInSet.Items.Count > 0 Then SaveSet(currSet)
    ...
    Private Sub lbSets_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lbSets.SelectedIndexChanged
        ...
        For Each tMovie As Movies In lMovies
            For Each mSet As Media.Set In tMovie.Movie.Sets
                If mSet.SetContainer.Set = Me.lbSets.SelectedItem.ToString Then
                    If Not String.IsNullOrEmpty(mSet.SetContainer.Order) Then
                        tMovie.Order = Convert.ToInt32(mSet.SetContainer.Order)
                    End If
    ...
    Private Sub btnRemove_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRemove.Click
        Dim i As Integer = Me.lbMoviesInSet.SelectedIndex
    ...
    Friend Class Sets
        ...
        Public Sub AddMovie(ByVal sMovie As Movies)
            _movies.Add(sMovie)
        End Sub
