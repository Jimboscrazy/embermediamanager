...
Public Class Images : Implements IDisposable
    ...
    Public Function GetPreferredImage(ByVal IMDBID As String, ByVal iType As Enums.ImageType, ByRef imgResult As Containers.ImgResult, ByVal sPath As String, ByVal doETs As Boolean, Optional ByVal doAsk As Boolean = False) As Boolean
                    ...
                    Else
                        ...
                        For Each tmdbThumb As MediaContainers.Image In tmpListTMDB
                            ...
                            If Not IsNothing(tmdbThumb.WebImage.Image) Then
                                ...
                                Save(Path.Combine(CachePath, String.Concat("poster_(", tmdbThumb.Description, ")_(url=", StringUtils.CleanURL(tmdbThumb.URL), ").jpg")))
                            End If
                            Me.Clear()
                        Next
                    End If
                            ...
                            If tmpListIMPA.Count > 0 Then
                                ...
                                For Each iImage As MediaContainers.Image In tmpListIMPA
                                    ...
                                    If Not IsNothing(_image) Then
                                        ...
                                        Dim tmpSize As Enums.PosterSize = GetPosterDims(_image)
