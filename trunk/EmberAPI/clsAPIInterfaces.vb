Public Class Interfaces
    ...
    Public Interface EmberTVScraperModule
        ...
        Function GetSingleImage(ByVal ShowID As Integer, ByVal TVDBID As String, ByVal Type As Enums.TVImageType, ByVal Season As Integer, ByVal Lang As String, ByVal CurrentImage As Image, ByRef Image As Image) As ModuleResult
