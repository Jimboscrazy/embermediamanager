...
Public Class emmSettings
    ...
    ' Will have to consider a write later function.. when cached are save and not the real ones!
    Private _usecachenfo As Boolean
    Private _readfirstcachenfo As Boolean 'Not yet in Use , Means read caached nfo before trying real nfo ... false do the inverse ofc
    Private _readcacheimages As Boolean 'Not yet in Use, Means try to load poster and funart to display from cached ones 
