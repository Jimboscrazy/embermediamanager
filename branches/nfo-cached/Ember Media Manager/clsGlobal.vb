        ...
        Try
            ...
            If eSettings.UseCacheNFO Then
                ...
                Using SQLNewcommand As SQLite.SQLiteCommand = Master.SQLcn.CreateCommand
                    SQLNewcommand.CommandText = String.Concat("SELECT id FROM movies WHERE path LIKE """, sPath.Substring(0, sPath.Length - sPath.LastIndexOf(",")), "%"";")
                ...
                If Not id = vbNullString Then
                    Dim mePath As String = String.Concat(Application.StartupPath, Path.DirectorySeparatorChar, "cache", Path.DirectorySeparatorChar, id, ".nfo")
                    If File.Exists(mePath) AndAlso Not Master.eSettings.ValidExts.Contains(Path.GetExtension(mePath)) Then
            ...
            End If
        Catch
            ' Don't catch out from Sub on this... still have non cached nfo to check
            ...
            Else
                ...
                If Not isFile AndAlso eSettings.MovieNFO Then
                    ...
                    If Not File.Exists(tPath) OrElse (Not CBool(File.GetAttributes(tPath) And FileAttributes.ReadOnly)) Then
                        ...
                        ' Cached nfo
                        If eSettings.UseCacheNFO Then
                            Dim mePath As String = String.Concat(Application.StartupPath, Path.DirectorySeparatorChar, "cache", Path.DirectorySeparatorChar, movieToSave.ID, ".nfo")
