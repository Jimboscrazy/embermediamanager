...
Public Class DefaultStrings
    Public Shared Tables As String() = {"CREATE TABLE IF NOT EXISTS Movies(" & _
                                        ...
                                        ");", _
                                        "CREATE TABLE IF NOT EXISTS Sources(ID INTEGER PRIMARY KEY AUTOINCREMENT, Name TEXT NOT NULL, path TEXT NOT NULL, Recursive BOOL NOT NULL DEFAULT False , Foldername BOOL NOT NULL DEFAULT False, Single BOOL NOT NULL DEFAULT False);", _
