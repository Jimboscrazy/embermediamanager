...
7za a "Packages\EMM_r%EMM_REV%_exeonly_%4.zip" "Ember Media Manager.exe" > nul 2> nul
7za a "Packages\EMM_r%EMM_REV%_exeonly_%4.zip" "License.txt" > nul 2> nul
7za a "Packages\EMM_r%EMM_REV%_exeonly_%4.zip" "README.rtf" > nul 2> nul
7za a "Packages\EMM_r%EMM_REV%_exeonly_%4.zip" "Ember Media Manager.exe.manifest" > nul 2> nul
del /Q "License.txt"
del /Q "README.rtf"
del /Q "Ember Media Manager.exe.manifest" 
del /Q "Ember Media Manager.exe"
echo Package for %4 Created [Release %EMM_REV%]
echo Package create in: %3
) ELSE (
echo ERROR: Package for %4 NOT Created
)
